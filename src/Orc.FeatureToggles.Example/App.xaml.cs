...
using Orc.Controls;
using Orc.FeatureToggles.Example.FeatureToggles.Providers;
using Orc.FeatureToggles.Example.Services;
    ...
    public App()
    {
        var hostBuilder = new HostBuilder()
            .ConfigureServices((hostContext, services) =>
            {
                ...
                services.AddOrcFeatureToggles();
                services.AddOrcFeatureTogglesXaml();
